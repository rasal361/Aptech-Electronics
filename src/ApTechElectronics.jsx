    ...
    <>
      ...
      <section id="home" style={{
        ...
        <div className="fu0" style={{ display:"inline-flex", alignItems:"center", gap:8, background:"var(--canvas2)", border:"1px solid var(--line)", borderRadius:20, padding:"5px 16px", marginBottom:28 }}>
          ...
          <span style={{ fontFamily:"'Jost',sans-serif", fontSize:11, fontWeight:600, letterSpacing:".1em", textTransform:"uppercase", color:"var(--ink2)" }}>Sayh Mudayrah, Ajman</span>
        </div>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:80, alignItems:"center" }}>
            ...
            <div style={{ position:"relative" }}>
              <div style={{ borderRadius:"16px", background:"var(--canvas2)", border:"1px solid var(--line)", aspectRatio:"4/3", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", overflow:"hidden" }}>
                ...
                <div style={{ marginTop:24, textAlign:"center", padding:"0 24px" }}>
                  ...
                  <div style={{ fontFamily:"'Jost',sans-serif", fontSize:12, color:"var(--ink3)", marginTop:4 }}>Sayh Mudayrah · Est. 2009</div>
                </div>
              </div>
              {/* Floating tag */}
              <div style={{ position:"absolute", bottom:-18, right:-18, background:"var(--card-bg)", border:"1px solid var(--line)", borderRadius:"10px", padding:"12px 20px", boxShadow:"0 8px 32px var(--shadow)" }}>
                <div style={{ fontFamily:"'Jost',sans-serif", fontSize:11, fontWeight:600, letterSpacing:".1em", textTransform:"uppercase", color:"var(--ink3)" }}>Ajman, UAE</div>
            ...
            <div>
              ...
              <p className="body-t" style={{ marginBottom:32 }}>
                Aptech Electronics has been a trusted part of the Sayh Mudayrah community for over 15 years. We carry everything from flagship smartphones to home appliances, with genuine products, official warranties, and a team that actually knows their tech.
              </p>
              {[
      ...
      <section id="contact" style={{ background:"var(--canvas)", borderTop:"1px solid var(--line)", padding:"100px 0" }}>
        <W>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1.5fr", gap:40 }}>
            <div>
              {[
                ["📍","Address","Sayh Mudayrah, Ajman, UAE\nNear Sheikh Khalifa Hospital A2"],
                ["🕐","Hours","Open Daily\n7:00 AM – 11:00 PM"],
                ["📞","Phone","Mobile: 0505936217\nTel: 048522105"],
              ].map(([icon,title,text])=>(
            ...
            <div style={{ borderRadius:"16px", background:"var(--canvas2)", border:"1px solid var(--line)", height:320, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", gap:14, position:"relative", overflow:"hidden" }}>
              ...
              <div style={{ position:"relative", zIndex:2, textAlign:"center" }}>
                ...
                <div style={{ fontFamily:"'Jost',sans-serif", fontSize:12, color:"var(--ink3)", marginTop:4, marginBottom:18 }}>Sayh Mudayrah, Ajman, UAE</div>
                <a href="https://maps.google.com/?q=Sayh+Mudayrah+Ajman+UAE" target="_blank" rel="noreferrer"
      ...
      <footer style={{ background:"var(--footer-bg)", padding:"56px 40px 32px" }}>
        <div style={{ maxWidth:1080, margin:"0 auto", display:"flex", flexDirection:"column", alignItems:"center", textAlign:"center" }}>
          ...
          <div style={{ fontFamily:"'Jost',sans-serif", fontSize:11, fontWeight:500, letterSpacing:".1em", textTransform:"uppercase", color:"rgba(255,255,255,.3)", marginBottom:8 }}>Abdul Rasheed Electronics</div>
          <div style={{ fontFamily:"'Jost',sans-serif", fontSize:14, color:"rgba(255,255,255,.4)", fontWeight:300, marginBottom:32 }}>Your Trusted Electronics Store in Sayh Mudayrah</div>
          ...
          <div style={{ display:"flex", gap:32, flexWrap:"wrap", justifyContent:"center", marginBottom:20 }}>
            {["🕐 Open Daily  7 AM – 11 PM","📞 048522105"].map(t=>(
      ...
      <div style={{ position:"fixed", bottom:22, right:22, zIndex:999, display:"flex", flexDirection:"column", gap:8 }}>
        <a href="tel:048522105" className="s-call">📞 Call Us</a>
        <a href="https://wa.me/971505936217" target="_blank" rel="noreferrer" className="s-wa">
